...
public abstract class AbstractBeanCopier {
    ...
    private static final Type CLASS_UTIL = TypeUtils.parseType(UtilClass.class.getName());
    ...
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) {
            ...
            PropertyDescriptor[] getters = UtilReflect.getBeanGetters(source);
            PropertyDescriptor[] setters = UtilReflect.getBeanSetters(target);
            ...
            for (PropertyDescriptor setter : setters) {
                ...
                CopyProperty targetIgnoreCopy = UtilReflect.getAnnotation(target, propName, CopyProperty.class);
                // set 上有忽略的 注解
                if (targetIgnoreCopy != null) {
                    ...
                    if (UtilString.isNotBlank(aliasTargetPropName)) {
                ...
                // 判断类型是否一致，包括 包装类型
                if (UtilClass.isAssignable(setterPropertyType, getterPropertyType)) {
                    // 2018.12.27 by L.cm 支持链式 bean
        ...
        protected Object firstInstance(Class type) {
            return UtilBean.newInstance(type);
        }
